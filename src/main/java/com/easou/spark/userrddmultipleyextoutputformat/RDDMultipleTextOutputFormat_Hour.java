...
/**
 * ClassName RDDMultipleTextOutputFormat_Hour
 * 功能: 重写输出类
 * Author yangweifeng
 * Date 2018/11/23 10:13
 * Version 1.0
 **/
public class RDDMultipleTextOutputFormat_Hour extends MultipleTextOutputFormat {
    ...
    protected String generateFileNameForKeyValue(Object key, Object value, String name) {
        return super.generateFileNameForKeyValue(key, value, DateUntil.getDateOneHourAgo() + "_" + name);
    }
}