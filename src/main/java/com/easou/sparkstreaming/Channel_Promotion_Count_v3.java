 ...
 * Version 1.0
 **/
public class Channel_Promotion_Count_v3 extends AbstractCommonHelper implements BIModel {
       ...
       // SparkConf sparkConf = new SparkConf().setAppName(ConfigLoader.getProperties(UserConstants.APPLICATION_NAME));
        ...
        lines.mapToPair(new PairFunction<String, String, Integer>() {
            ...
            public Boolean call(Tuple2<String, Integer> stringIntegerTuple2){
                return !UserConstants.UPDATE.equals(stringIntegerTuple2._1);
            }
        }).mapToPair(new PairFunction<Tuple2<String, Integer>, String, String>() {
            @Override
            public Tuple2<String, String> call(Tuple2<String, Integer> stringIntegerTuple2) {
                return new Tuple2<>(stringIntegerTuple2._1 + "," + stringIntegerTuple2._2,"");
            }
        }).foreachRDD(new VoidFunction<JavaPairRDD<String, String>>() {
            @Override
            public void call(JavaPairRDD<String, String> stringIntegerJavaPairRDD) {
                stringIntegerJavaPairRDD.repartition(1).saveAsHadoopFile(ConfigLoader.getProperties(UserConstants.SPARK_MINUTE_OUTPUT) ,String.class,NullWritable.class, RDDMultipleTextOutputFormat.class);
            }
        });
    ...
    public static void main(String[] args) {
        Channel_Promotion_Count_v3 channel_promotion_count = new Channel_Promotion_Count_v3();
